 ...
 *
 * Local, 127.0.0.1 y previews de Vercel (*.vercel.app): no hay subdominios,
 * así que se habilita TODO para poder probar sin fricción.
 *
...
const PUBLIC_HOSTS = ['gotechy.com', 'www.gotechy.com'];
