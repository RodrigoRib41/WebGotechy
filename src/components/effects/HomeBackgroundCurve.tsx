      ...
      >
        <defs>
          <linearGradient id={`curve-grad-${variant}`} x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#00E5FF" stopOpacity={stopStart} />
            <stop offset="8%" stopColor="#00E5FF" stopOpacity={stopEarly} />
            <stop offset="50%" stopColor="#33E0FF" stopOpacity={stopMid} />
            <stop offset="92%" stopColor="#1DE9B6" stopOpacity={stopLate} />
            <stop offset="100%" stopColor="#1DE9B6" stopOpacity={thickenWithScroll ? '0.4' : '0'} />
          </linearGradient>
